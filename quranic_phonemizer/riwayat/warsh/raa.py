...
SITES = (
    ...
    _site("raa_misr_waqf", (12, 21, 5), (12, 21, 5), "مِّصْرَ"),
    ...
    _site("raa_ishruna_kibr", (40, 55, 14), (40, 56, 14), "كِبْرٞ"),
    ...
    _site("raa_alif_hamza", (6, 139, 21), (6, 138, 21), "اَ۪فْتِرَآءً"),
    _site("raa_alif_hamza", (6, 141, 13), (6, 140, 13), "اُ۪فْتِرَآءً"),
    _site("raa_alif_hamza", (18, 23, 5), (18, 22, 27), "مِرَآءٗ"),
    _site("raa_dual_alif", (2, 124, 17), (2, 125, 17), "طَهِّرَا"),
...
BY_OWNER = {
    ...
    "raa_firq": _keys((26, 63, 11)),
    "raa_misr_waqf": _keys((10, 87, 8), (12, 21, 5), (12, 99, 10), (43, 51, 10)),
    "raa_alqitr_waqf": _keys((34, 12, 10)),
    "raa_yasr_waqf": _keys((89, 4, 3)),
    "raa_asr_waqf": _keys((11, 81, 9), (15, 65, 1), (44, 23, 1)),
    "raa_wanuthur_waqf": _keys(
        (54, 16, 4), (54, 18, 6), (54, 21, 4),
        (54, 30, 4), (54, 37, 9), (54, 39, 3),
    ),
    "raa_ishruna_kibr": _keys((8, 65, 10), (40, 56, 14)),
    "raa_alishraq": _keys((38, 18, 7)),
    "raa_hayran": _keys((6, 71, 23)),
    "raa_bisharar": _keys((77, 32, 3)),
    "raa_five_words": _keys(
        (2, 200, 10), (18, 70, 12), (18, 83, 9), (20, 99, 13),
        (20, 113, 14), (21, 48, 7), (33, 41, 6), (37, 3, 2),
        (37, 168, 4), (65, 10, 16), (77, 5, 2), (18, 90, 15),
        (18, 71, 15), (20, 100, 8), (25, 22, 9), (25, 53, 14),
    ),
    "raa_sihra": _keys((25, 54, 9)),
    "raa_iram": _keys((89, 7, 1)),
    "raa_alif_ayn": _keys((18, 18, 12), (50, 44, 5), (70, 43, 5), (69, 32, 6)),
    "raa_alif_hamza": _keys((6, 138, 21), (6, 140, 13), (18, 22, 27)),
    "raa_dual_alif": _keys((2, 125, 17), (20, 63, 4), (28, 48, 21), (55, 35, 8)),
    "raa_ashiratukum": _keys((9, 24, 8)),
    "raa_wizraka": _keys((94, 2, 3)),
    "raa_dhikraka": _keys((94, 4, 3)),
    "raa_wizra_ukhra": _keys((6, 164, 19), (17, 15, 14), (35, 18, 4), (39, 7, 18), (53, 38, 4)),
    "raa_ijrami": _keys((11, 35, 8)),
    "raa_hidhrakum": _keys((4, 71, 5), (4, 102, 56)),
    "raa_ibrah_kibrahu": _keys(
        (3, 13, 27), (12, 111, 5), (16, 66, 5), (23, 21, 5),
        (24, 44, 8), (79, 26, 4), (24, 11, 24),
    ),
    "raa_hasirat_suduruhum": _keys((4, 90, 11)),
...
PROFILE = RaaProfile(
    by_owner=BY_OWNER,
    heavy=_union(
        "raa_alishraq", "raa_hayran", "raa_five_words", "raa_sihra",
        "raa_iram", "raa_fixed_ibrahim_heavy", "raa_fixed_israil_heavy",
        "raa_fixed_imran_heavy", "raa_fixed_repeated_heavy",
    ),
    light=_union(
        "raa_firq", "raa_ishruna_kibr", "raa_bisharar", "raa_alif_ayn",
        "raa_alif_hamza", "raa_dual_alif", "raa_ashiratukum", "raa_wizraka",
        "raa_dhikraka", "raa_ijrami", "raa_hidhrakum", "raa_ibrah_kibrahu",
        "raa_fixed_hidhrahum_light", "raa_fixed_other_ashir_light",
    ),
    waqf_heavy=_union("raa_misr_waqf", "raa_asr_waqf"),
    waqf_light=_union("raa_alqitr_waqf", "raa_yasr_waqf", "raa_wanuthur_waqf")
    | frozenset({(Location(77, 32, 3), 2)}),
    wasl_light=_union("raa_wizra_ukhra", "raa_hasirat_suduruhum"),
