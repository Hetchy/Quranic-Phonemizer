...
| The first naql-modified badal row used a tanwin host, so 147 ordinary moved-haraka hosts remained canonically voweled and never triggered naql. | Coverage and adapter defect | Added a separate A/U/I matrix for moved-haraka, tanwin, and ayah-edge joins; demote the host before an initial badal as for ordinary latent qata; and reconcile all 227 sites as 210 within-ayah plus 17 ayah-edge overlaps. |
