...
| ID | Options and default | Scope and examples | Effect | Source |
| --- | --- | --- | --- | --- |
| `iwaja_qayyima` | `sakt`, `idraj`; default `sakt` | `عِوَجَا قَيِّمًا`, 18:1 -> 18:2; joined reading only | `sakt` sets `sakt_after` on `عِوَجَا`, realizes the alif substituted for tanwin, and blocks `ikhfaa_haqiqi`. `idraj` continues directly and applies ordinary tanwin-before-qaf `ikhfaa_haqiqi`. | [Authenticated faces at the four positions](https://islamweb.net/amp/ar/library/content/70/115/) |
...
| `raa_wizra_ukhra_wasl` | `light`, `heavy`; default `light` | The five `وِزْرَ أُخْرَى` boundaries at 6:164, 17:15, 35:18, 39:7, and 53:38 | Wasl only. Stopping on `وِزْرَ` is fixed light; inclination in `أُخْرَى` is independent. | [Al-Nashr, wizra ukhra](https://www.islamweb.net/ar/library/content/70/183/) |
