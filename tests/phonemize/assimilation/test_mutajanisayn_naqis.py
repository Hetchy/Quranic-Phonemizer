...
CASES = (
    # بَسَطتَ
    Case(id="basatta", site=Site(hafs=("5:28", (2,))), read=isolated(),
    ...
    # أَحَطتُ
    Case(id="ahattu", site=Site(hafs=("27:22", (5,))), read=isolated(),
         ...
         sound_rules={"tˤ": R("idgham_mutajanisayn_naqis"),
                      "t": R("idgham_mutajanisayn_naqis")}),
    # فَرَّطتُمْ
    Case(id="farrattum", site=Site(hafs=("12:80", (21,))), read=isolated(),
         ...
         sound_rules={"tˤ": R("idgham_mutajanisayn_naqis"),
                      "t": R("idgham_mutajanisayn_naqis")}),
    # فَرَّطتُ
    Case(id="farrattu", site=Site(hafs=("39:56", (7,))), read=isolated(),
