...
CASES = (
    # يَوْمِ
    StateCase(id="waw", site=Site(hafs=("1:4", (2,))), states={
    ...
    # قُرَيْشٍ
    StateCase(id="yaa", site=Site(hafs=("106:1", (2,))), states={
    ...
    # قَوْلِى
    StateCase(id="final-long-negative", site=Site(hafs=("20:28", (2,))), states={
    ...
    # عَيْنًا
    StateCase(id="iwad-negative", site=Site(hafs=("2:60", (13,))), states={
