...
INSIDE_ONE_WORD = [
    ...
    ("7:192", 7, "jaŋˤsˤurˤu:n"),    # يَنصُرُونَ
    ("56:29", 2, "maŋˤdˤu:dQ"),      # مَّنضُودٍ
    ("37:92", 4, "taŋˤtˤiqu:n"),     # تَنطِقُونَ
    ("7:14", 2, "ʔaŋˤðˤirni:"),      # أَنظِرْنِىٓ
    ("2:3", 8, "juŋfiqu:n"),        # يُنفِقُونَ
    ("7:119", 3, "waŋˤqaˤlabu:"),    # وَٱنقَلَبُوا۟
...
TANWEEN_ACROSS_A_BOUNDARY = [
    ...
    ("69:6", (4, 5), ("biri:ħiŋˤ", "sˤaˤrˤsˤaˤrˤ")),    # بِرِيحٍ صَرْصَرٍ
    ("25:39", (1, 2), ("wakullaŋˤ", "dˤaˤrˤaˤbQna:")),  # وَكُلًّا ضَرَبْنَا
    ("51:53", (5, 6), ("qaˤwmuŋˤ", "tˤaˤ:ɣu:n")),       # قَوْمٌ طَاغُونَ
    ("4:57", (19, 20), ("ðˤillaŋˤ", "ðˤaˤli:la:")),     # ظِلًّا ظَلِيلًا
    ("6:86", (5, 6), ("wakullaŋ", "fadˤdˤaˤlna:")),    # وَكُلًّا فَضَّلْنَا
    ("16:117", (1, 2), ("mata:ʕuŋˤ", "qaˤli:l")),       # مَتَـٰعٌ قَلِيلٌ
