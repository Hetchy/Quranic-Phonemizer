...
def test_a_final_fatha_is_dropped_at_a_stop(r):
    ...
    assert r.silent(1) == {"َ"}
    assert "waqf_diacritic_drop" in r.rules_on_char(1, "ك")
...
def test_that_fatha_is_sounded_when_the_reading_carries_on(r):
    ...
    assert "waqf_diacritic_drop" not in r.rules_on_char(1, "ك")
...
def test_a_final_damma_is_dropped_at_a_stop(r):
    ...
    assert r.silent(2) == {"ُ"}
    assert "waqf_diacritic_drop" in r.rules_on_char(2, "ب")
...
def test_that_damma_is_sounded_when_the_reading_carries_on(r):
    ...
    assert "waqf_diacritic_drop" not in r.rules_on_char(2, "ب")
...
def test_a_final_kasra_is_dropped_at_a_stop(r):
    ...
    assert r.silent(3) == {"ِ"}
    assert "waqf_diacritic_drop" in r.rules_on_char(3, "ب")
...
def test_that_kasra_is_sounded_when_the_reading_carries_on(r):
    ...
    assert "waqf_diacritic_drop" not in r.rules_on_char(3, "ب")
